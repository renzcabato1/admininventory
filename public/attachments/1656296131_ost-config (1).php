...
define('SECRET_SALT','996d22e94e2d1f40ff88f8be71625ea9');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','pmmc.equipment@premiummegastructures.com');
...
define('DBNAME','macbuild_osti809');
define('DBUSER','macbuild_osti809');
define('DBPASS','h5]5p[S09S');

# Table prefix
define('TABLE_PREFIX','ostko_');
