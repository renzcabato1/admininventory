...
define('SECRET_SALT','5uZM6UOtR5Pzau4VChnFsODecvp0l92P');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','denniscuerdo@gmail.com');
...
define('DBNAME','premiu23_osticketdb');
define('DBUSER','premiu23_osticketdb');
define('DBPASS','Gh@rbzseth2014');
