<div class="modal fade" id="declineRequest" tabindex="-1" role="dialog" aria-labelledby="cancelRequestData" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="cancelRequestData">Declined Request</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            </div>
            <div class="modal-body">
                <form method='post' action='declined-request' onsubmit='show();'  enctype="multipart/form-data">
                    {{ csrf_field() }}
